...
import 'package:tddcleanarchitecture/features/number_trivia/data/repositories/number_trivia_repositories_impl.dart';
...
void main() {
  ...
  group("getConcreteNumberTrivia", () {
    const tNumber = 1;
    const tNumberTrviaModel =
        NumberTriviaModel(text: 'test trivia', number: tNumber);
    const NumberTrivia tNumberTrivia = tNumberTrviaModel;
    ...
    runTestsOnline(() {
      ...
      test(
        ...
        // assert
        verify(mockRemoteDataSource.getConcreteNumberTrivia(tNumber));
        verify(mockLocalDataSource.cacheNumberTrivia(tNumberTrviaModel));
      });
